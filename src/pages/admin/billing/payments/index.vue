  ...
  <div data-testid="admin-payments-page">
    <VCard>
      <VCardText class="d-flex flex-wrap justify-space-between align-center gap-4">
        <h5 class="text-h5">Riwayat Payment</h5>
      </VCardText>
      ...
      <VCardText>
        <VRow>
          ...
          <VCol cols="12" sm="2" class="d-flex align-center">
            <VBtn variant="outlined" @click="paymentStore.resetFilter()">Reset</VBtn>
          </VCol>
        </VRow>
      </VCardText>
      ...
      >
        ...
        <template #item.paymentGateway="{ item }">
          <VChip size="small" :color="getGatewayColor(item.paymentGateway)" variant="tonal">
            {{ item.paymentGateway }}
          </VChip>
        </template>
